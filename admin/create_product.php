...
if(isset($_POST['create_product'])){
    ...
    $image_name1=$product_name."bt1.jpg";
    $image_name2=$product_name."bt2.jpg";
    $image_name3=$product_name."bt3.jpg";
    $image_name4=$product_name."bt4.jpg";
    ...
    $stmt= $conn->prepare("INSERT INTO products(product_name,product_description,
                                    product_price,product_special_offer,product_image,
    ...
    $stmt->bind_param('ssssssssss',$product_name,$product_description,$product_price,
                        $product_special_offer,$image_name1,$image_name2,$image_name3,$image_name4,
